...
.controller('IonicDemoCtrl', function($scope, $ionicModal, $ionicLoading) {
  $scope.$demos = DEMOS;
    ...
    $scope.demoScratch = function(demo) {
      ...
      .val(['<html ng-app="sideMenuWithNav">',
           '<head>',
           '  <meta charset="utf-8">',
